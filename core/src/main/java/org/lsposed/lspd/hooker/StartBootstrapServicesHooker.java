...
public class StartBootstrapServicesHooker implements XposedInterface.Hooker {
    ...
    public static void beforeHookedMethod() {
        ...
        try {
            PmxpedInit.loadedPackagesInProcess.add("android");

            XC_LoadPackage.LoadPackageParam lpparam = new XC_LoadPackage.LoadPackageParam(PmxpedBridge.sLoadedPackageCallbacks);
