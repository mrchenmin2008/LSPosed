 ...
 */
public interface IPmxpedHookInitPackageResources extends IPmxpedMod {
    /**
    ...
    final class Wrapper extends XC_InitPackageResources {
        private final IPmxpedHookInitPackageResources instance;
        public Wrapper(IPmxpedHookInitPackageResources instance) {
